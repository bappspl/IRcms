$(function () {
    ...
    if ($('#datatable-category').length > 0){
            ...
            "drawCallback": function(  data ) {
                ...
                setTimeout(function () {
                    ...
                    $('.check-all').on('ifChecked', function (event) {
                        selectedIds = [];
                        $('#datatable-category tbody tr td .check-row').iCheck('check');
                        //console.log(selectedIds);
                    });
                    ...
                    $('.check-all').on('ifUnchecked', function (event) {
                        selectedIds = [];
                        $('#datatable-category tbody tr td .check-row').iCheck('uncheck');
                        //console.log(selectedIds);
                    });
                },0);

                //massive action select
                if($('#datatable-category_length select[name="massive-action"]').length === 0)
                {
                    $('#datatable-category_length').append($('.massive-action').html());
                }
        ...
        // delete modal
        $('#datatable-category tbody').on('click', '.btn-danger', function (e) {
            e.preventDefault();
