...
namespace CmsIr\Zf2SlugGenerator\Service\Factory;

use Zend\ServiceManager\FactoryInterface;
use Zend\ServiceManager\ServiceLocatorInterface;
use CmsIr\Zf2SlugGenerator\Service\Slug;
...
class SlugFactory implements FactoryInterface
{
    ...
    {
        $mapper = $serviceLocator->get('CmsIr\Zf2SlugGenerator\Mapper\DbTable');
